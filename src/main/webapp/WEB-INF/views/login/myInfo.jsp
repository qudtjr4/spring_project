...
<body class="w3-light-grey w3-content" style="max-width:1750px">
<dis class= container >
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="/login/myInfo" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-user fa-fw w3-margin-right"></i>My Information</a> 
...
<div class="w3-main" style="margin-left:300px">
  ...
  <!-- MyInfo Section -->
 <form action="/login/myModifyInfo" method="post">
  <div class="w3-container w3-padding-large w3-grey">
    <h4 id="MyInfo"><b>My Information</b></h4>
    <hr class="w3-opacity">
      <div class="w3-section">
        <label>ID</label>
        <input class="w3-input w3-border" type="text" name="mem_id" value="${MemberVO.mem_id}" disabled="disabled">
      </div>
      <div class="w3-section">
        <label>Password</label>
        <input class="w3-input w3-border" type="password" name="mem_pw"value="${MemberVO.mem_pw}" required>
      </div>
      <div class="w3-section">
        <label>Name</label>
        <input class="w3-input w3-border" type="text" name="mem_name"value="${MemberVO.mem_name}" required>
      </div>
      <div class="w3-section">
        <label>Email</label>
        <input class="w3-input w3-border" type="text" name="mem_email"value="${MemberVO.mem_email}" required>
      </div>
      <button type="submit" class="w3-button w3-black w3-margin-bottom"><i class="fa fa-paper-plane w3-margin-right"></i>Modify</button>
      ...
      <h3>현재 프로필사진</h3>
        ...
        <div id="uploadedList">
			...
			<span class="mailbox-attachment-icon has-img"> 
			 <img src="/displayFile?fileName=${MemberVO.mem_img}" class="w3-left w3-margin-right" style="width:150px;height:150px">
			</span>
			<div class="mailbox-attachment-info">
				 <span style="cursor: pointer;">
					 <small data-src="name"><span class="glyphicon glyphicon-remove"></span></small>
				 </span> 
				 <input type="hidden" name="mem_img" value="${MemberVO.mem_img}" />
			</div>
  ...
  <div class="w3-black w3-center w3-padding-12"><%@ include file="../include/footer.jsp" %></div> 
...
<script id="template" type="text/x-handlebars-template">
	...
	<div>
		...
		<div class="mailbox-attachment-info">
			...
			<input type="hidden" name="mem_img" id="mem_img" value="{{imageName}}"/>
		</div>
	</div>
