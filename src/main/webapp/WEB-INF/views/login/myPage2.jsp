...
<section id="tm_sec">
	<div class="container">
		<div class="row">
			...
			<c:forEach items="${ThemeList}" var="ThemeInfoDTO" >
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs12 ">
				<div class="title_sec">
				
					<h1><a href="/theme/themeDetail?page=1&keyword=&lineUp=&theme_no=${ThemeInfoDTO.theme_no}">${ThemeInfoDTO.theme_title}</a><span style="color:red">(클릭)</span></h1>
				</div>			
			</div>		
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs12">
				<div class="all_team">
					<c:forEach items="${ThemeInfoDTO.listMap}" var="map" begin="0" varStatus="status" end="${ThemeInfoDTO.listMap.size()}">
