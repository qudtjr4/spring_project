...
<form id="" method="post" action="/admin/placeInput">
<input type="hidden" name="plc_map_x" id="plc_map_x" value="">
<input type="hidden" name="plc_map_y" id="plc_map_y" value="">
				...
				<div class="form-group">
					...
					<select class="form-control" name="loc_no">
						<c:forEach items="${locationList}" var="LocationVO">
							<option value="${LocationVO.loc_no}">${LocationVO.loc_name}</option>
						</c:forEach>
					</select>
				</div>
			...
			<div class="form-group">
				...
				<input type="text" name="plc_time" class="form-control openTime"
					required="required" placeholder="Ex) 10:00-21:00">
			</div>
			...
			<div class="form-group">
				...
				<input type="text" name="plc_tel" class="form-control tel"
					required="required" placeholder="Tel">
			</div>
			
			<div class="form-group">
				<h3><label for="info">정보</label></h3>
				<textarea name="plc_info" class="form-control info" id="info" rows="10"></textarea>
			</div>
			
			<div class="form-group">
				<h3><label for="hashTag">해시태그</label></h3>
				<input type="text" name="plc_hashtag" class="form-control hashTag"
					required="required" placeholder="Hashtag Ex)#OOO #△△△">
			</div>
			...
			<div class="form-group" id="search">
				...
				<input type="text" name="searchMap" class="form-control mapPosition" 
					required="required" id="searchMap" style="width:30%;float:left">
